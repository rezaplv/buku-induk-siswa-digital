  ...
  render() {
    ...
    sidebar.innerHTML = `
      ...
      <nav class="sidebar-nav">
        ...
        <a class="nav-item" data-page="ekstrakurikuler" onclick="Router.navigateTo('ekstrakurikuler')">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a class="nav-item" data-page="kokurikuler" onclick="Router.navigateTo('kokurikuler')">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a class="nav-item" data-page="cetak-buku-induk" onclick="Router.navigateTo('cetak-buku-induk')">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
