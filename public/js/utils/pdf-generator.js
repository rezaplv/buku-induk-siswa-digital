  ...
  downloadAsWord(bodyContent, filename) {
    ...
    <head>
      ...
      <style>
        ...
        .print-header h1 { font-size: 11pt; font-weight: bold; margin-bottom: 16px; }
        ...
        .desc-cell { text-align: justify; text-justify: inter-word; font-size: 11pt; word-spacing: -0.5pt; hyphens: auto; -ms-hyphens: auto; -webkit-hyphens: auto; }
